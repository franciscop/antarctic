...
`main` contains the source code of the latest published version of the library and its docs.
...
PRs for changes to the docs should be made against the `main` branch.
...
PRs for changes to the library source code should be made against the `main` branch.
